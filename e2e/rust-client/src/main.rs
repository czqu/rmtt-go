//! Cross-language E2E probe: the `rmtt` Rust client (crates.io v0.1.0,
//! https://github.com/czqu/rmtt-rust) against the Go rmtt server
//! (e2e/go-server). It connects over TCP, pushes a message upstream and
//! verifies the server's echo comes back downstream. Exit 0 on success.
